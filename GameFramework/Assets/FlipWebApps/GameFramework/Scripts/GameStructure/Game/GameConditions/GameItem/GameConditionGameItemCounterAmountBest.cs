...
namespace GameFramework.GameStructure.Game.GameConditions.GameItem
{
    ...
    /// </summary>
    [System.Serializable]
    [ClassDetails("GameItem: Counter Amount Best", "GameItem/Counter Amount Best", "Testing a GameItem counters best amount.")]
    public class GameConditionGameItemCounterAmountBest : GameConditionGameItemContextSelectableTypeCounter
    {
        /// <summary>
        ...
        public override bool EvaluateCondition(MonoBehaviour monoBehaviour)
        {
            ...
            if (gameItem)
            {
                ...
                if (counterReference.Configuration.CounterType == ObjectModel.CounterConfiguration.CounterTypeEnum.Int)
                    return GameConditionHelper.CompareNumbers(counterReference.IntAmountBest, Comparison, IntAmount);
                else 
                    return GameConditionHelper.CompareNumbers(counterReference.FloatAmountBest, Comparison, FloatAmount);
            }
            return false;
        }
    }
