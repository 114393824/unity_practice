...
namespace GameFramework.GameStructure.Game.GameConditions.GameItem
{
    ...
    /// </summary>
    [System.Serializable]
    [ClassDetails("GameItem: Coins", "GameItem/Coins", "Testing the coins of a GameItem.")]
    public class GameConditionGameItemCoins : GameConditionGameItemContextSelectableTypeInt
    {
        /// <summary>
