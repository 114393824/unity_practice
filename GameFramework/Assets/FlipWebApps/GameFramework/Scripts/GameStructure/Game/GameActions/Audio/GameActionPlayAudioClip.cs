...
namespace GameFramework.GameStructure.Game.GameActions.Audio
{
    /// <summary>
    /// GameAction class that instantiates the specified prefab.
    /// </summary>
    [System.Serializable]
    [ClassDetails("Play Audio Clip", "Audio/Play Audio Clip", "Play the specified Audio clip.")]
    public class GameActionPlayAudioClip : GameAction
    {
        /// <summary>
        ...
        public override void SetReferencesFromContainer(UnityEngine.Object[] objectReferences)
        {
            if (objectReferences != null && objectReferences.Length == 1)
                AudioClip = objectReferences[0] as AudioClip;
        }
