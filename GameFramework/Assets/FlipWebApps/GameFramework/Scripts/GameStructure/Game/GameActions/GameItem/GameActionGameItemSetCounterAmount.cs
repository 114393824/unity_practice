...
namespace GameFramework.GameStructure.Game.GameActions.GameItem
{
    ...
    /// </summary>
    [System.Serializable]
    [ClassDetails("GameItem: Set Counter Amount", "GameItem/Set Counter Amount", "Set the specified counter amount for a given GameItem")]
    public class GameActionGameItemSetCounterAmount : GameActionGameItemContextSelectableTypeCounter
    {
        /// <summary>
        /// Perform the action
        /// </summary>
